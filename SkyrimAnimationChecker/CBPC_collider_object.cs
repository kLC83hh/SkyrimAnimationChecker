...
{
    public class CBPC_collider_object : Notify.NotifyPropertyChanged
    {
        public CBPC_collider_object() { }
        public CBPC_collider_object(string name, string data) { this.Name = name; this.Data = data; }
